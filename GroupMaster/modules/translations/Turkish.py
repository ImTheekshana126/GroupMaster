...
TurkishStrings = {
    "send-start": """Merhaba {}, benim adım {}! Beni nasıl kullanacağın hakkında soruların varsa, /help okuyun @groupmasternaviya_bot  gidin.

Ben bir [bu kişi](tg://user?id={654839744}) tarafından yönetilen bir grup yönetim botuyum.
...
Githubda pull requests göndermekten çekinme, yada destek grubuma, @leosupportx'a sorun bildirmek, soru sormak için \
